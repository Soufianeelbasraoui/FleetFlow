...
ALTER TABLE chauffeur MODIFY available BOOLEAN DEFAULT TRUE;
ALTER TABLE vehicule  MODIFY statut_vehicule VARCHAR(255) DEFAULT 'AVAILABLE';
ALTER TABLE livraison MODIFY statut VARCHAR(255) DEFAULT 'PENDING';
